...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post buyers_url, params: { buyer: { address: @buyer.address, email: @buyer.email, name: @buyer.name, phone: @buyer.phone } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { address: @buyer.address, email: @buyer.email, name: @buyer.name, phone: @buyer.phone } }
